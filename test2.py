...
while cap.isOpened():
    ...
    if highest_confidence_box:
        ...
        if last_bounce_classification != "N/A":
            cv2.putText(frame, f"Bounce Classification: {last_bounce_classification}", (10, height - 40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
            cv2.putText(frame, f"Length Description: {last_length_description}", (10, height - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
            cv2.putText(frame, f"Shot Type: {shot_type}", (10, height - 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
